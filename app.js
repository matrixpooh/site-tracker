...
//...make sure that socket.handshake.headers.host is equal to the host we defined in
//our config file and that socket.handshake.headers.referer contains localhost:5000/dashboard.
// If the condition is met, we will send the data to that socket, which is our dashboard socket in this case.
